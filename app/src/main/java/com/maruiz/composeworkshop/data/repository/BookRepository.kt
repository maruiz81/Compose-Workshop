...
class BookRepository {
            ...
            listOf(
                ...
                BookDataModel(
                    ...
                    listOf(
                        GENRE_CLASSICS,
                        GENRE_FICTION,
                        GENRE_CULTURAL_FRANCE,
                        GENRE_LITERATURE,
                        GENRE_LITERATURE_FRENCH,
                        GENRE_PHILOSOPHY
                    )
                ),
                BookDataModel(
    ...
    companion object {
        private const val GENRE_CLASSICS = "Classics"
        private const val GENRE_FICTION = "Fiction"
        private const val GENRE_CULTURAL_RUSSIA = "Cultural-Russia"
        private const val GENRE_ROMANCE = "Romance"
        private const val GENRE_HISTORICAL_FICTION = "Historical-Historical Fiction"
        private const val GENRE_ACADEMIC_SCHOOL = "Academic-School"
        private const val GENRE_LITERATURE = "Literature"
        private const val GENRE_LITERATURE_FRENCH = "European Literature-French Literature"
        private const val GENRE_LITERATURE_SPANISH = "European Literature-Spanish Literature"
        private const val GENRE_CULTURAL_FRANCE = "Cultural-France"
        private const val GENRE_PHILOSOPHY = "Philosophy"
        private const val GENRE_ADVENTURE = "Adventure"
        private const val GENRE_NOVELS = "Novels"
        private const val GENRE_PLAYS = "Plays"
        private const val GENRE_POETRY = "Poetry"
        private const val GENRE_DRAMA = "DRAMA"
        private const val GENRE_FANTASY_MYTHOLOGY = "Fantasy-Mythology"
    }
}